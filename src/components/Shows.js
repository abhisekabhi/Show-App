    ...
    movies = [
        {
            ...
            "show": {
                ...
                "name": "All American",
                "description":"This show is osm watch it and enjoy...",
                "type": "Scripted",
                "language": "English",
                "genres": [
                    "Drama",
        ...
        },
        {
            ...
            "show": {
                ...
                "ended": null,
                "officialSite": "https://www.cbs.com/shows/all-rise/",
                "schedule": {
                    "time": "21:00",
                    "days": [
                        "Monday"
                ...
                "image": {
                    "medium": "https://static.tvmaze.com/uploads/images/medium_portrait/407/1018801.jpg",
                    "original": "https://static.tvmaze.com/uploads/images/original_untouched/407/1018801.jpg"
                },
                ...
                "_links": {
                    ...
                    "previousepisode": {
                        "href": "https://api.tvmaze.com/episodes/2079505"
                    },
                    "nextepisode": {
                        "href": "https://api.tvmaze.com/episodes/2320782"
                    }
                }
            }
        },
        ...
        },
        {
            ...
            "show": {
                ...
                "_links": {
                    ...
                    "previousepisode": {
                        "href": "https://api.tvmaze.com/episodes/2307161"
                    }
                }
            }
        },
        ...
        },
        {
            ...
            "show": {
                ...
                "_links": {
                    ...
                    "previousepisode": {
                        "href": "https://api.tvmaze.com/episodes/1274600"
                    }
                }
            }
        },
                ...
                <div className='row'>
                    {this.state.movies.map((element) => {
                        return <div className='col-md-4' key={element.url}>
                            <ShowsItem title={element.show.name} description={element.show.description} imageUrl={element.show.image.original} showUrl={element.show.url} />
                        </div>
                    })}
